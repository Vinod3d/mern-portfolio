...
const HomePage = () => {
  ...
  }, [isAuthenticated, dispatch, error, navigate, message]);
      ...
      <div className="flex min-h-screen w-full flex-col bg-muted/40">
        <aside className="fixed inset-y-0 left-0 hidden w-14 flex-col border-r bg-background sm:flex z-50">
          <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
            <Link className=" flex h-9 w-9 shrink-0 items-center justify-center gap-2 rounded-full bg-primary text-lg font-semibold text-primary-foreground md:h-8 md:w-8 md:text-base">
          ...
          <Sheet>
            ...
            <SheetContent side="left" className="w-[400px] sm:w-[540px]">
              <nav className="grid gap-3 text-lg font-medium">
                <Link className="flex mb-5 shrink-0 cursor-text items-center justify-left gap-5 rounded-full  text-lg font-semibold text-primary-foreground md:text-base">
                  {/* <Package2 className="h-5 w-5 transition-all hover:scale-110"/>
                <span className="sr-only">Packages</span> */}
                  ...
                  />
                  <h1 className="text-2xl text-muted-foreground hover:text-foreground">
                    Hi! {user?.fullName ? user.fullName.split(" ")[0] : "Guest"}
                  </h1>
                </Link>
                <Link
                  href="#"
                  className={`flex items-center gap-4 p-2.5 rounded-lg  ${
                    active === "Dashboard"
                ...
                <Link
                  className={
                    "flex items-center gap-4 p-2.5 rounded-lg text-muted-foreground hover:text-foreground "
                  }
                  onClick={handleLogout}
                >
